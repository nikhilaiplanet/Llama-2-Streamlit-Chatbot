...
if uploaded_file:
    ...
    )  # any loader can be put here based on the data being used
    ...
    def conversational_chat(query):
        ...
        result = chain(
            {
                "question": query
                + "You're a AI financial adviser who answers questions based on given context if question is out of context then just say I don't know.",
                "chat_history": st.session_state["history"],
            }
        )  # enduser query and result variable
